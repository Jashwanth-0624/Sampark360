...
function useDeprecatedUniqueId(prefix2, options = defaults) {
  return useMemo3(() => `${prefix2}${options.separator}${count$1++}`, [options.separator, prefix2]);
}
function useUniqueId(prefix2, options = defaults) {
  const id = import_react4.default.useId();
  return useMemo3(() => `${prefix2}${options.separator}${id}`, [options.separator, prefix2, id]);
}
